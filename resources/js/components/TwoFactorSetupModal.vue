...
const modalConfig = computed<TwoFactorConfigContent>(() => {
    if (props.twoFactorEnabled) {
        return {
            ...
            description:
                'La verificación en dos pasos quedó activada. Escaneá el código QR o ingresá la clave en tu app de autenticación.',
            buttonText: 'Cerrar',
        };
    }
    ...
    return {
        ...
        description:
            'Para terminar de activarla, escaneá el código QR o ingresá la clave en tu app de autenticación',
        buttonText: 'Continuar',
    };
});
